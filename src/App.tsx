...
function App() {
  ...
  <div className="wallet-container">
    <button className="wallet-button" onClick={connectWallet}>Connect to Wallet</button>
    <button className="wallet-button" onClick={createWallet}>Generate new account & airdrop 2 sol</button>
    <button className="wallet-button" onClick={getWalletBalance}>Check new account balance</button>
    <button className="wallet-button" onClick={transferToWallet}>Transfer amount</button>
  </div>
